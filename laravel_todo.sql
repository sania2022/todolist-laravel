...
(5, '2022_02_22_115023_create_todos_table', 1);
...
CREATE TABLE `todos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `task` varchar(255) COLLATE utf8_general_ci NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 0,
  `date_created` varchar(255) COLLATE utf8_general_ci NOT NULL DEFAULT '2022-02-23 13:50:02',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `todos` (`id`, `task`, `status`, `date_created`, `created_at`, `updated_at`) VALUES
(1, 'get groceries for home', 0, '2022-02-23 13:50:22', NULL, NULL),
(2, 'More tasks', 0, '2022-02-23 13:50:27', NULL, NULL),
(3, 'Another task', 0, '2022-02-23 13:50:30', NULL, NULL);
